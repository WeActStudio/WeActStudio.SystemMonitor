...
from lib.lcd.color import Color, parse_color
    ...
    def openSerial(self):
        if self.com_port == 'AUTO':
            ...
            if not self.com_port:
                error_str = "Cannot find COM port automatically, please run Configuration again and select COM port manually"
        ...
        try:
            ...
            error_str = f"Cannot open COM port {self.com_port}: {e}"
            logger.error(error_str)
            raise Exception(error_str)
